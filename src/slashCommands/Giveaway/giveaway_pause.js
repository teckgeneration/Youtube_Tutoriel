...
module.exports = {
    name: "giveaway-pause",
    description: "Permet de mettre le giveaway en pause",
    owner: false,
    options: [
        {
            name: "message_id",
    ...
    run: async (client, interaction) => {
        ...
        client.giveawaysManager.pause(messageID).then(async () => {
            await interaction.reply({content: `✅ Le giveaway à bien été mis en pause !!`, ephemeral: true})
        }).catch((err) => {
